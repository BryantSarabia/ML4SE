...
async function loadExamples() {
    try {
        ...
        exampleComments = [
            ...
            { text: "I will find you and hurt you!", category: "threat" },
...
function loadExample(index) {
    if (exampleComments[index]) {
        document.getElementById('comment-input').value = exampleComments[index].text;
    }
}
...
async function analyzeComment() {
    ...
    try {
        ...
        showError('Error: Could not connect to the API server. Make sure the server is running.');
        hideResults();
    }
}
...
function displayResults(data) {
    ...
    document.getElementById('highest-risk-label').textContent = highestRisk.replace('_', ' ');
